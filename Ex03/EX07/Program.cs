...
// Calcule a média
double media = (nota1 + nota2 + nota3) / 4;
...
{
    Console.WriteLine("Situação:ce é loco, num compensa");
}
else
{
    Console.WriteLine("Situação: Vacilou");

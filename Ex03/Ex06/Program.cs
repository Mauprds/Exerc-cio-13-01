...
//Verificar se a pessoa pode entrar no evento
...
else
{
    ...
    Console.WriteLine("Você NÂO pode entrar no evento");

}
Console.WriteLine("=======================");

Console.WriteLine("Você é maior e tem autorização?"
+ (idade >= 18 && possuiAutorização));
Console.WriteLine("Você não é maior de idade?" + (idade < 18));
Console.WriteLine(" Você é maior de idade ou possui autorização?" + (idade >= 18 || possuiAutorização));
